...
public class InsurancePolicy {
	...
	@NotNull(message = "Vehicle category must be selected")
	...
	@NotBlank(message = "Coverage details cannot be empty")
	...
	public InsurancePolicy(Long policyId, String policyName, VehicleCategory vehicleCategory, String description,
